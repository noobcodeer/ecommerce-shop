            ...
            <div className="col-lg-12">
              <div className="hb-menu">
                <nav className="navbar navbar-expand-sm navbar-light bg-light">
                  <Link className="navbar-brand" to="/"><img src="https://www.pngkey.com/png/full/508-5089438_history-transparent-background-house-icon-png.png" alt="not found" style={{height: 30, width: 30}}/></Link>
